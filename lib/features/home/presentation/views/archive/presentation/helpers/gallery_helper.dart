...
String convertToRangeDates(GalleryGroupFilesEntity entity) {
  ...
  if ((entity.mainVideo != null &&
      entity.mainVideo!.dateTime.day != startDate.day)) {
    toDate = entity.mainVideo!.dateTime;
  }
  if (entity.additionalFiles.isNotEmpty &&
      entity.additionalFiles.last.dateTime.day != startDate.day) {
...
Future<String> getPlaceFromCoordinate(double lat, double long) async {
  ...
  if (geocodeFromPoint.response!.geoObjectCollection!.metaDataProperty!
