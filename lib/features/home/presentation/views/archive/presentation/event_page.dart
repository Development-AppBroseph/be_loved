...
class EventPageInArchive extends StatefulWidget {
  ...
  const EventPageInArchive(
      {Key? key, required this.pageController, required this.nextPage})
      : super(key: key);
...
class _EventPageInArchiveState extends State<EventPageInArchive> {
        ...
        return Column(children: [
          ...List.generate(
            ...
            (index) => GestureDetector(
                ...
                child: _buildEvent(
                    context, eventsBloc.eventsOld[index], GlobalKey())),
          ),
          SizedBox(
              height: eventsBloc.eventsOld.isEmpty
                  ? 0
  ...
  Widget _buildEvent(
      BuildContext context, EventEntity event, GlobalKey eventSettingsKey) {
              ...
              children: [
                ...
                Text(
                  ...
                  DateFormat('dd.MM.yy').format(DateTime.now()
                      .add(Duration(days: int.parse(event.datetimeString)))),
                  style: TextStyle(
                    color:
                        getColorFromDays(event.datetimeString, event.important),
                    fontSize: 15.sp,
