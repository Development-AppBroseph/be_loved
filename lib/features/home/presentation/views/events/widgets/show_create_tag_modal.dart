...
showModalCreateTag(BuildContext context, bool isCreate, [TagEntity? tagEntity, int? selectedEvent]) async {
  return await showMaterialModalBottomSheet(
    ...
    builder: (context) {
      return TagModal(isCreate: isCreate, editingTag: tagEntity, selectedEvent: selectedEvent,);
    });
}
