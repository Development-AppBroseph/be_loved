            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!(state is StaticsLoadingState ||
                          state is StaticsInitialState) &&
                      staticsBloc.staticsEntity != null) ...[
                    Text(
                      'События',
                      style: TextStyles(context).black_18_w800,
                    ),
                    _buildStatsItem(context, 'Созданных событий:',
                        '${staticsBloc.staticsEntity!.events}'),
                    Text(
                      'Архив',
                      style: TextStyles(context).black_18_w800,
                    ),
                    _buildStatsItem(context, 'Добавленных файлов:',
                        '${staticsBloc.staticsEntity!.archive}'),
                    Text(
                      'Цели',
                      style: TextStyles(context).black_18_w800,
                    ),
                    _buildStatsItem(context, 'Достигнутых целей:',
                        '${staticsBloc.staticsEntity!.completeTargets}'),
                  ]
                ],
              ),
            ),
