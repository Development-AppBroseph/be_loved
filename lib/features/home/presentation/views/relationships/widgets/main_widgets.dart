...
class MainWidgets extends StatelessWidget {
  ...
  deleteFileWidget(BuildContext context, int id, GlobalKey keyg) {
    fileWidgetDeleteModalModal(context, getWidgetPosition(keyg), () {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MainWidgetsBloc, MainWidgetsState>(
      ...
      if (state is MainWidgetsInitialState ||
          state is MainWidgetsLoadingState) {
        return Container();
      }
            ...
            if (bloc.mainWidgets.file != null) ...[
              EventPhotoCard(
                ...
                onAdditionWithKeyTap: (g) {
                  deleteFileWidget(
                      context, (bloc.mainWidgets.file!.widgetId ?? 1), g!);
                },
                onTap: () {
                  Navigator.of(context).push(PageRouteBuilder(
                    pageBuilder: (_, __, ___) => bloc.mainWidgets.file!.isVideo
                        ? VideoView(
                            url: (bloc.mainWidgets.file!.urlToFile
                                    .contains('http')
                        ...
                        : PhotoFullScreenView(
                            urlToImage: (bloc.mainWidgets.file!.urlToFile
                                    .contains('http')
                                ? bloc.mainWidgets.file!.urlToFile
                                : (Config.url.url +
                                    bloc.mainWidgets.file!.urlToFile)),
                ...
                url: bloc.mainWidgets.file!.isVideo
                    ? (bloc.mainWidgets.file!.urlToPreviewVideoImage != null &&
              ...
              ...bloc.mainWidgets.purposes
                  .map((e) => Padding(
                        ...
                        child: PurposeCard(
                          ...
                          isMainWidget: true,
                          deleteTap: () {
                            context.read<MainWidgetsBloc>().add(
                                DeletePurposeWidgetEvent(id: e.widgetId ?? 1));
                          },
                        ),
                      ))
                  .toList()
