...
class _DecorBottomsheetState extends State<DecorBottomsheet> {
  ...
  addImageBack() async {
    ...
    if (newFile != null) {
      ...
      final File newImage =
          await File(newFile.path).copy('$path/image_$epoch.png');
            ...
            child: Row(
              children: [
                _buildThemeItem(context,
                    isDarkTheme: false, isSelected: sl<AuthConfig>().idx == 0),
                SizedBox(
                  width: 18.w,
                ),
                _buildThemeItem(context,
                    isDarkTheme: true, isSelected: sl<AuthConfig>().idx == 1)
              ],
            ),
          )
        ],
  ...
  _buildThemeItem(BuildContext context,
      {required bool isDarkTheme, bool isSelected = false}) {
    return Expanded(
      child: GestureDetector(
        onTap: () {
          context
              .read<ThemeBloc>()
              .add(UpdateThemeEvent(index: isDarkTheme ? 1 : 0));
        },
        child: SizedBox(
          height: 150.h,
          child: CupertinoCard(
                ...
                children: [
                  ...
                  Positioned.fill(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text(isDarkTheme ? 'Темная' : 'Светлая',
                              style:
                                  // isDarkTheme
                                  // ?
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 150.h,
          child:
              BlocConsumer<DecorBloc, DecorState>(listener: (context, state) {
            ...
            if (state is DecorLoadingState ||
                state is DecorInitialState ||
                decorBloc.back == null) {
              return Container();
            }
            return ListView(
                    ...
                    .map((e) => GestureDetector(
                          onTap: () {
                            decorBloc.add(EditBackgroundEvent(
                                backFileEntity: null,
                                assetPhoto:
                                    MainConfigApp.decorBackgrounds.indexOf(e)));
                          },
                          child: Container(
                            margin: EdgeInsets.only(right: 10.w),
                            height: 150.h,
                            ...
                            child: Stack(
                              children: [
                                ...
                                if (MainConfigApp.decorBackgrounds.indexOf(e) ==
                                        decorBloc.back!.assetPhoto &&
                                    decorBloc.back!.backPhoto == null)
                                  Positioned(
                                      bottom: 10.h,
                                      right: 0,
                                      left: 0,
