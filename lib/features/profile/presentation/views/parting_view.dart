          ...
          Positioned.fill(
            ...
            child: Column(
              ...
              children: [
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text: '(а)',
                        style: TextStyles(context).black_35_w800.copyWith(color: ColorStyles.blackColor)
                      ),
                      const TextSpan(
                        text: '?',
                      ),
                ...
                Text('Расставание — не выход.', style: TextStyles(context).grey_15_w800,),
                ...
                Padding(
                  ...
                  child: CustomAnimationButton(
                    ...
                    red: true,
                    onPressed: () async {
                      bool? isPart = await showModalSendFile(context, isParting: true);
                      if(isPart != null && isPart){
                        Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) => PartingSecondView()));
                      }
                    },
                  ),
                ),
