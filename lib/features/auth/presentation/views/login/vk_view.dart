...
class _VKViewState extends State<VKView> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://oauth.vk.com/authorize?client_id=51521402&display=page&redirect_uri=https://oauth.vk.com/blank.html&scope=friends&response_type=code&v=5.52'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: ClrStyle.greyToBlack2C[sl<AuthConfig>().idx],
      ),
      body: WebViewWidget(
